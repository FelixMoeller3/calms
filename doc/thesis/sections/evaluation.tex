...
After having conducted our experiments with the Continual Learning strategies Naive, \gls{ewc}, \gls{mas}, IMM and \gls{alasso} as well as the Active Learning strategies
