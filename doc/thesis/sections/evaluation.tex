...
as the target and substitute model and perform one model stealing attack for each combination of Active Learning, Continual Learning strategy and target model output. As a baseline we use the Model Extraction using Active Learning with the strategies mentioned before.
For each Active Learning strategy, we highlight the best performing Continual Learning strategy in bold. To evaluate the performance of the Active Learning strategies, we average the results of all Continual Learning strategies for a fixed Active Learning strategy.
Again, the best performing Active Learning strategy is highlighted in bold\par
...
\ref{fig:ModelStealingMNISTSoftmax}.
...
\begin{table}[h]
    ...
    \begin{tabular}{c | c c c c c | c } 
        ...
        \hline 
        Baseline & 85.6 & 85.65 & 83.67 & 90.65 & 81.62 & 85.44\\
        \hline
...
\begin{table}[h]
    ...
    \begin{tabular}{c | c c c c c | c} 
        ...
        \diagbox[width=11em]{Active \\ Learning Strategy}{Continual Learning \\ Strategy} & Random & LC & BALD & CoreSet & Badge & $\varnothing$ \\ 
        \hline 
        Baseline & 60.34 & 72.77 & 70.2 & 77.58 & 72.15 & 70.61\\
        \hline
...
\begin{table}[h]
    ...
    \begin{tabular}{c | c c c c c | c} 
        ...
        \diagbox[width=11em]{Active \\ Learning Strategy}{Continual Learning \\ Strategy} & Random & LC & BALD & CoreSet & Badge & $\varnothing$\\ 
        \hline 
        Baseline & 70.98 & 69.4 & 72.65 & 71.61 & 71.39 & 71.21\\
        \hline
...
\begin{table}[h]
    ...
    \begin{tabular}{c | c c c c c | c} 
        ...
        \diagbox[width=11em]{Active \\ Learning Strategy}{Continual Learning \\ Strategy} & Random & LC & BALD & CoreSet & Badge & $\varnothing$\\ 
        \hline 
        Baseline & 55.12 & 10.25 & 61.12 & 61.68 & 58.32 & 49.3\\
        \hline
...
\begin{table}[h]
    ...
    \begin{tabular}{c | c c c c | c} 
        ...
        \hline
        Naive & 18.46 & \textbf{18.48} & 16.8 & 17.69 \\
        EWC & \textbf{19.45} & 17.46 & \textbf{20.67} & \textbf{19.98}\\
...
\begin{table}[h]
    ...
    \begin{tabular}{c | c c c c } 
        ...
        \diagbox[width=11em]{Active \\ Learning Strategy}{Continual Learning \\ Strategy} & Random & LC & BALD & CoreSet \\ 
        \hline 
        Baseline & 21.26 & 19.89 & 21.0 & 20.96\\
        Naive & 7.93 & 7.63 & 4.98 & 4.82\\
        EWC & \textbf{8.79} & 6.55 & 2.07 & 7.77 \\
        IMM & 8.59 & \textbf{8.44} & 7.18 & \textbf{8.05} \\
        MAS & 5.37 & 5.44 & 5.3 & 4.52 \\
        Alasso & 5.28 & 6.11 & \textbf{5.72} & 5.51 \\
        \hline
...
\begin{table}[h]
    ...
    \begin{tabular}{c c c c c c c} 
        ...
        \hline
    \end{tabular}
    \caption{Comparison of Model Agreement (in \%) for Continual Active Learning using VAAL and AGEM and the Coreset Baseline}
    \label{fig:ModelStealingVAAL_AGEM}
\end{table}

%TODO redo left plot with new data
\begin{figure}[h]
    \centering
