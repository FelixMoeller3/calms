...
\begin{figure}[h]
    ...
    \caption[Continual active learning with \gls{badge} with batch size 4,000]{Comparison of validation accuracy of regularization-based continual learning strategies
...
%TODO: Überschrift vom linken Plot ändern
\begin{figure}[h]
    \centering
...
\begin{table}[h]
    ...
    \end{tabular}
    \caption{Comparison of model agreement (in \%) using \gls{vaal} and \gls{a-gem}.}
